...
import { IWorkflowStepBuilderExt, IWorkflowStepBuilder, ParallelType, WorkflowStepBuilder } from "./WorkflowStepBuilder";
...
export class WorkflowStepBuilderMoveNext<TInput, TOutput, TResult> extends WorkflowStepBuilderBase<TInput, TOutput, TResult> implements IWorkflowStepBuilder<TInput, TOutput, TResult> {
